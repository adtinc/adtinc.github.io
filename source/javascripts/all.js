...
var formatGoogleCalendar = (function() {
        ...
        for (i = 0; i < format.length; i++) {
           ...
           format[i] = format[i].toString();
            ...
            if (format[i] === '*summary*') {
                ...
                output = output.concat('<a href="https://www.google.com/maps/dir/' + location + '"><span class="location">' + location + '</span></a>');
            } else {
    ...
    return {
        init: function (settingsOverride) {
            var settings = {
                calendarUrl: 'https://www.googleapis.com/calendar/v3/calendars/adtinc97@gmail.com/events?key=AIzaSyAHGtAq_Dw25zUe78YHyMlEJAo8wBMJ0pc',
                past: false,
                upcoming: true,
                sameDayTimes: true,
                dayNames: false,
                ...
                upcomingHeading: '',
                pastHeading: '',
                format: ['*date*', ': ', '*summary*', ' &mdash; ', ' at ', '*location*']
            };
